...
<html lang="pt-br">
	...
	<body>
	    ...
	    <div class="content">
	    	<h2>Catálogo de Brinquedos :: Excluir Usuário</h2>
	    	<hr>
		
		<jsp:useBean id="user" scope="session" class="br.edu.exemplo.model.User" />
		<form action="ServletBrinquedo?cmd=excluirU" method="post" enctype="multipart/form-data">
				<table>
					<tr>
						<td>CÓDIGO:</td>
					...
					<tr>
						...
						<td><input type="text" size="60" name="password"
							value="<%=user.getPassword()%>" readonly="readonly" /></td>
					</tr>
				<tr>
