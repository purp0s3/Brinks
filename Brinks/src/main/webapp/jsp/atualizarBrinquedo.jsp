				...
				<table>
					...
					<tr>
						...
						<td><input type="text" size="60" name="txtDescricao"
							value="<%=brinquedo.getDescricao()%>"  /></td>
					</tr>
					<tr>
						<td>CATEGORIA:</td>
						<td>
					...
					<tr>
						...
						<td><input type="text" size="60" name="txtMarca" 
							value="<%=brinquedo.getMarca()%>"	/></td>
					</tr>
		
					<tr>
						<td>IMAGEM:</td>
						<td><input type="file" name="imagemFile" accept="image/*"
							value="<%=brinquedo.getImagem()%>" required/></td>
					</tr>
					<tr>
						<td>VALOR:</td>
						<td>
						<span style="position: absolute; margin-left: 15px; margin-top: 5px; font-weight: normal; font-size: 18px;">R$</span>
						<input type="number" size="60" name="txtValor"
					...
					<tr>
						...
						<td><input type="text" size="60" name="txtDetalhes" 
							value="<%=brinquedo.getDetalhes()%>" /></td>
					</tr>
					<tr>
