...
<html lang="pt-br">
	...
	<body>
			    ...
			    <tr>
			      ...
			      <td>
			        <form action="ServletBrinquedo" method="get">
			          <input type="hidden" name="cmd" value="atu">
			      ...
			      <td>
			        <form action="ServletBrinquedo" method="get">
			          <input type="hidden" name="cmd" value="exc">
			          <input type="hidden" name="txtId" value="<%=a.getId()%>">
		...
		<div class="content-new">
			<a href="html/incluir.html">Novo Brinquedo</a>
		</div><span>&nbsp</span> 
		<div class="content-neww">
			<a href="html/cadastro.html">Novo Usuário</a>
		</div><span>&nbsp</span>
		<div class="content-newww">
			<a href="ServletBrinquedo?cmd=listarUsuarios">Listar Usuários</a>
		</div>		  	
	</body>
</html>
